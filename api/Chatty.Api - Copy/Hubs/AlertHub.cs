using Chatty.Without.API;
using Chatty.Without.API.Hubs.Clients;
...
namespace AMNOne.Services.Notifications.Hub.Hubs
{
    public class AlertHub : Microsoft.AspNetCore.SignalR.Hub<IAlertClient>
    {
        ...
        /// </summary>
        /// <param name="user"></param>0
        /// <param name="message"></param>
        /// <param name="level"></param>
        /// <returns></returns>
        public Task BroadcastToCaller(string user, string message, string level)
        {
            return Clients.Caller.Broadcast(user, level, message);
        }
        ...
        public Task BroadcastToUser(string connectionId, string user, string message, string level)
        {
            return Clients.Client(connectionId).Broadcast(user, message, level);
        }

        public Task BroadcastUsingUser(string connectionId, string user, string message, string level)
        {
            return Clients.User(user).Broadcast(user, message, level);
        }
        ...
        /// <summary>
        /// This will send to all connected usersers.
        /// </summary>
        /// <param name="user"></param>
        /// <param name="message"></param>
        /// <param name="level"></param>
